        ...
        try:
            if player.lives > 0:
                if player.team.players[0] != player:
                    if not player.team.players[0].is_alive():
                        self.spawn_player(player.team.players[0])
                        player.team.players[0].lives += player.lives
                        for icon in player.team.players[0].icons:
                            icon.handle_player_spawned()
                    else:
                        player.team.players[0].lives += player.lives
                else:
